# SampleCSharpNUnitSelenium

This is an example of Acceptance Test Driven Development (ATDD) using
[C#](https://docs.microsoft.com/en-us/dotnet/csharp/), [NUnit](https://nunit.org/),
...
2. From the project root directory, run the `dockercomposerun`
   ...
   ```bash
   ./SampleCSharpNUnitSelenium/script/dockercomposerun
   ```
...
2. From the project root directory, run the `dockercomposerun`
   ...
   ```bash
   ./SampleCSharpNUnitSelenium/script/dockercomposerun bash
   ```
